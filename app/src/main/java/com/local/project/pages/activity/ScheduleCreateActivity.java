...
public class ScheduleCreateActivity extends BaseActivity<ActivityCreateScheduleBinding> {
    ...
    private String[] type = new String[]{"学习", "工作", "行程",
            "考试", "运动", "购物","做饭",
            "缴费", "打扫", "约会",
            "纪念日", "其他"};
    private int[] img = new int[]{R.drawable.ic_xx, R.drawable.ic_gz,
            R.drawable.ic_xc, R.drawable.ic_ks, R.drawable.ic_yd,
            R.drawable.ic_gw, R.drawable.ic_zf, R.drawable.ic_jf,
            R.drawable.ic_ds, R.drawable.ic_yh, R.drawable.ic_lw,R.drawable.ic_cy};
