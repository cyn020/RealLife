...
import com.local.project.data.UserInfo;
...
public class DiaryCreateActivity extends BaseActivity<ActivityDiaryCreateBinding> {
    ...
    private int[] music = new int[]{R.raw.littlestory, R.raw.paladin, R.raw.townofwindmill,R.raw.relaxing,R.raw.happy,R.raw.release};
    private String[] musicStr = new String[]{"time", "joy", "sadness","relaxing","happy","release the anger"};
    private int[] musicIc = new int[]{R.drawable.ic_music, R.drawable.ic_music, R.drawable.ic_music,R.drawable.ic_music,R.drawable.ic_music,R.drawable.ic_music};
